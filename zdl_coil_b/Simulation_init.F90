...
#include "Flash.h"
  ...
  call RuntimeParameters_get('sim_targAmplitude', sim_targAmplitude)
  call RuntimeParameters_get('sim_targPeriod', sim_targPeriod)
...
call RuntimeParameters_get('useDipole', useDipole)
call RuntimeParameters_get('sim_magfac', sim_magfac)
...
!open(unit=1, file="foam.txt")

!do row1=1,2000

!read(1,*) (foam(row1,col1),col1=1,2000)
!end do
